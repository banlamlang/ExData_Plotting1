plot4 <- function() {
  ...
  par(mfrow = c(2,2))
  plot(dat$date, dat$global_active_power, xlab="", ylab="Global Active Power", type="n")
  lines(dat$date, dat$global_active_power)
  
  plot(dat$date, dat$voltage, xlab="datetime", ylab="Voltage", type="n")
  ...
  plot(dat$date, dat$global_reactive_power, xlab="datetime", ylab="Global_reactive_power", type="n")
